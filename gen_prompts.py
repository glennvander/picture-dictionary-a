...
NEG_COMMON = (
    ...
    "place the subject on a wooden board or tray unless described. Every person "
    "has exactly two arms, two hands and two legs, each joined to the body at "
    "the right place — no extra, missing or floating limbs. Draw every object at "
    "its true real-world size next to any person shown: a jar, a glass or a pair "
    "of scissors is small enough to hold in one hand, never as large as a "
    "person's body. Never draw "
